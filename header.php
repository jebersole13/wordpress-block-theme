<?php
/**
 * PJW functions and definations.
 */

if ( ! function_exists( 'PJW_setup' ) ) {
    /**
    ...
    function PJW_setup() {
		 ...
		 * to change 'PJW' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'PJW', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'PJW_custom_background_args', array(
		...
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary', 'PJW' ),
            'footer' => esc_html__( 'Footer Menu', 'PJW' ),
            'header_action' => esc_html__( 'Header Action', 'PJW' ),
		) );

		add_filter( 'show_admin_bar', '__return_false' );
    }
}
add_action( 'after_setup_theme', 'PJW_setup' );
 ...
 */
function PJW_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'PJW_content_width', 1170 );
}
add_action( 'after_setup_theme', 'PJW_content_width', 0 );
 ...
 * @since 1.0.0
 */
function PJW_sidebar_widgets_init() {
	// Default Sidebar
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'PJW' ),
		'id'            => 'default-sidebar',
		'description'   => esc_html__( 'Add widgets here.', 'PJW' ),
...
add_action( 'widgets_init', 'PJW_sidebar_widgets_init' );

/**
 * Enqueue public scripts and styles.
 */
function PJW_public_scripts() {
    // Styles.
...
add_action( 'wp_enqueue_scripts', 'PJW_public_scripts' );

/**
 * Enqueue admin scripts and styles.
 */
function PJW_admin_scripts() {

}
add_action( 'admin_enqueue_scripts', 'PJW_admin_scripts' );
